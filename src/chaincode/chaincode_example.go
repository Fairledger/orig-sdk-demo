...
//	}
	...
	if len(args) != 2 {
		resp := "Incorrect number of arguments. Expecting 2 but received: " + string(len(args))
		//return nil, errors.New("Incorrect number of arguments. Expecting 2 but received: %s", len(args))
